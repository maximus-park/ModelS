...
class SceneObject {
 public:
  ...
  virtual void draw_normal() { draw(); }
  virtual void draw_shading() { draw(); }
...
class Scene {
 public:
  ...
  void render_in_normal_mode();
  void render_in_shading_mode();
  /**
  ...
  void resample_selected_mesh(size_t numProxy, size_t numIterations, double edgeSplitThreshold);
