  ...
  namespace CMU462 {
    ...
    class Face : public HalfedgeElement {
      public:
        ...
        /**
         * This field is used for Variational Shape Approximation.
         * After generating proxy, proxyIndex indicates which group this face
         * belongs to.
         * A default value of -1 indicates that proxy group is not assigned.
         */
        ProxyLabel label = -1;
        Color getProxyColor() const;
    ...
    class HalfedgeMesh {
      public:
         ...
         * mesh
         */
        VertexIter splitEdge(EdgeIter e, bool markNew = false);
        ...
        bool displayVSA = false; ///< flag indicating whether we are displaying VSA segmentation or not
